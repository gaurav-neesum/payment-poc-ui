...
!function (e, t) {
  ...
  return function (e) {
    ...
    function N(e) {
      if (e instanceof Array && e.length > 0) for (var t, n, r = e.length; --r;) n = ~~(Math.random() * (r + 1)), t = e[r], e[r] = e[n], e[n] = t
    }
    ...
    t.a = {
      CAPTURE_CONTEXT_INVALID: function () {
        return new o({reason: "CAPTURE_CONTEXT_INVALID", message: "You have not supplied a valid capture context."})
      }, CAPTURE_CONTEXT_EXPIRED: function () {
        return new o({reason: "CAPTURE_CONTEXT_EXPIRED", message: "Your capture context has expired."})
      }, BROWSER_ENCRYPTION_FAILED: function () {
        return new o({reason: "BROWSER_ENCRYPTION_FAILED", message: "In-browser encryption has failed."})
        ...
        return new o({reason: "CREATE_TOKEN_NO_FIELDS_LOADED", message: "No fields have been loaded."})
      }, CREATE_TOKEN_TIMEOUT: function (e) {
        var t = new o({reason: "CREATE_TOKEN_TIMEOUT", message: "Create token request timed out.", details: {}});
        ...
        return new o({reason: "CREATE_TOKEN_NO_FIELDS", message: "No fields for collection."})
        ...
        return new o({
          ...
          details: e.map((function (e) {
            return {message: "Validation error", location: e}
          }))
        })
        ...
        return new o({reason: "CREATE_TOKEN_UNABLE_TO_START", message: "Unable to trigger tokenization."})
        ...
        return new o({reason: "FIELD_SUBSCRIBE_UNSUPPORTED_EVENT", message: "Unsupported event name."})
      }, FIELD_SUBSCRIBE_INVALID_CALLBACK: function () {
        return new o({reason: "FIELD_SUBSCRIBE_INVALID_CALLBACK", message: "The supplied callback is not a function."})
      }, IFRAME_JWT_VALIDATION_FAILED: function () {
        return new o({reason: "IFRAME_JWT_VALIDATION_FAILED", message: "Invalid JWT."})
      }, IFRAME_UNSUPPORTED_FIELD_TYPE: function (e) {
        return new o({reason: "IFRAME_UNSUPPORTED_FIELD_TYPE", message: "Unsupported field type:  ".concat(e, ".")})
        ...
        return new o({reason: "API_INTERNAL_ERROR", message: "An unknown error has occurred."})
      }, API_JSON_PARSER_ERROR: function () {
        return new o({reason: "API_JSON_PARSER_ERROR", message: "There was a problem processing your request."})
        ...
        return new o({reason: "API_GATEWAY_ERROR", message: "The API gateway rejected your request."})
        ...
        return Array.isArray(e) && e.forEach((function (e) {
          e.location && n[e.location] && t.details.push({location: n[e.location], message: e.message})
        })), t
      }
    }
  }, function (e, t, n) {
    ...
    var r = "autocomplete", o = "blur", i = "change", a = "error", u = "focus", c = "inputSubmitRequest", s = "load",
      f = "unload", l = "update"
  }, function (e, t, n) {
    "use strict";
  ...
  */
    ...
    var r = "autocompleteEdit", o = "clear", i = "tokenize", a = "error"
  }, function (e, t, n) {
    "use strict";
    n.d(t, "a", (function () {
      return s
    ...
    function i(e, t, n) {
      ...
      function f(e, t) {
        ...
        if (!i[e]) return !1;
        for (var n = i[e], o = 0; o < n.length; o += 1) if (n[o] === t) return n.splice(o, 1), !0;
        return !1
      }

      function l(e, t, n) {
        var o = {event: e, channel: a, contentType: "application/x-telegram+json", data: t || {}};
      ...
      function d(e) {
        ...
        if ((c === t || "*" === c) && Object(r.j)(e.data) && "application/x-telegram+json" === e.data.contentType && "event" in e.data && !(!"application/x-telegram+json".indexOf(e.data.event) < 0 || void 0 !== e.data.channel && e.data.channel !== a && "*" !== e.data.channel)) {
          ...
          e.data.reply && n.push(function (e) {
            ...
            if (i[e]) for (var r = i[e].length, o = 0; o < r; o += 1) i[e][o].apply(n, t)
          }(e.data.event, n, e)
        }
      }
      ...
      return window.addEventListener("message", d, !1), {
        ...
        }, subscribe: s, unsubscribe: f, unsubscribeAll: E, teardown: function () {
    ...
    var r = n(1), o = n(0), i = n(3), a = n(5), u = n(6), c = n(4), s = n.n(c), f = n(2), l = n(7);
    ...
    var b = Object.keys(_).map((function (e) {
        ...
        "aria-label": {type: "string", required: !1},
        "aria-required": {type: "boolean", required: !1},
        disabled: {type: "boolean", required: !1},
        styles: {type: "object", required: !1}
      }, A = s()({}, O, {autoformat: {type: "boolean", required: !1}}),
      T = s()({}, O, {maxLength: {type: "number", required: !1, supportedValues: [3, 4]}}),
      g = Object.keys(f).map((function (e) {
        return f[e]
      })), y = "/cybersource/assets/microform/".concat("0.11.5", "/iframe.html");

    function v(e, t, n, r, o, i) {
      var a = {microformId: t, fieldId: n, jwt: e.jwt, microformConfig: r, config: o, fieldType: i};
    ...
    function N(e, t, n, r) {
      ...
      t.subscribe(f.LOAD, (function (e) {
        ...
        !function (e, t) {
          if (t && ("next" === t.focusShift || "previous" === t.focusShift)) {
            var n = Array.prototype.slice.call(document.querySelectorAll(E)).filter((function (e) {
              var t = e.getAttribute("tabindex"), n = e.getBoundingClientRect();
        ...
        s()(u._config, e), !0 === e.disabled ? r.parentElement.classList.add(_.disabled) : r.parentElement.classList.remove(_.disabled), I(n, f.UPDATE, e)
    ...
    var L = function () {
      function e(t, n, i, a) {
        ...
        var c = Object(o.u)();
        this._iframe = v(t, n, c, a, this._config, i), this._telegram = new l.a(this._iframe, c, t.origin), this._pubSub = new d, this._container = null, this._loaded = !1, N.call(this, i, this._telegram, this._pubSub, this._iframe)
      }
      ...
      return t = e, (n = [{
        ...
        key: "unload", value: function () {
          ...
          if (this._loaded = !1, this._iframe.onload = null, this._container) {
            for (; this._container.lastChild;) this._container.removeChild(this._container.lastChild);
        ...
        key: "load", value: function (e) {
          ...
          var o = function (e, t) {
            try {
              var n = e.indexOf("#"), r = JSON.parse(e.substr(n + 1));
              return s()(r.config, t), "".concat(e.substring(0, n), "#").concat(JSON.stringify(r))
            } catch (t) {
              return e
            }
          }(this._iframe.getAttribute("src"), this._config);
          for (this._iframe.setAttribute("src", o); this._container.lastChild;) this._container.removeChild(this._container.lastChild);
    ...
    var C = Object.keys(i).map((function (e) {
      return i[e]
    })), j = {styles: {type: "object", required: !1, default: {}}}, x = function () {
      function e(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        D(this, e), n = Object(u.a)(n, j), this._microformId = Object(o.u)(), this._flexConfig = t, this._baseConfig = {styles: n.styles}, this.fields = {}
      }

      var t, n, i;
      return t = e, (n = [{
        key: "createField", value: function (e, t) {
        ...
        key: "createToken", value: function (e, t) {
          var n = this, i = [], u = Object.keys(this.fields).reduce((function (e, t) {
    ...
    var P = function () {
      function e(t) {
        !function (e, t) {
          ...
          return Object.freeze({jwt: e, keyId: t.flx.jwk.kid, origin: t.flx.origin})
        }(t)
      }

      var t, n, i;
      return t = e, (n = [{
        key: "microform", value: function (e) {
